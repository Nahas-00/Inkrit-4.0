...
const Events = () => {
  ...
  const allEvents = {
    ...
    102: { id: 102, title: "Debugging",date: "Jan 16", time: "10:30 AM", location: "BCA Lab", image: "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?q=80&w=1169&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", icon: <Zap />, description: "Find flaws, secure the bag.Fight asgainst time to fix the bugs", prize: "₹ 5,000", rules: ["Individuals or teams of up to two can participate.","The competition will be conducted in 2 rounds.","Electronic gadgets, including laptops, are not allowed inside the competition venue.","Questions are only from C or Cpp.","Any misbehave or cheating will lead to disqaulification of the team.","Judges decesions will be final",], contact: [{name: "Aysha", phone: "6282112238"} ,{ name: "Ann grace" , phone:"7736672724"}], regFee: "₹ 200",regLink:"https://docs.google.com/forms/d/e/1FAIpQLSfJYoUUvSiiOBhmfJjtWDZl8fimYkgtjnM_rEZzsIF_3lhaFw/viewform?usp=header" },
    ...
    203: { id: 203, title: "Spot Dance", date: "Jan 17", time: "10 AM", location: "Auditorium", image: dance , icon: <Music />, description: "The Stage is Set. The Spotlight Awaits. Witness the ultimate fusion of athleticism and artistry!From explosive power moves to breathtaking technical precision, experience the passion and grit of performers who have spent days preparing for this single moment.", prize: "₹ 3,000", rules: ["Registration fee: ₹100 per participant (non-refundable)","Participants must report at the venue between 8:30 AM and 9:30 AM at the registration counter.","Round 1 – Freestyle Round: Participants must perform their own choreography. The audio track must be submitted to the coordinator in advance (MP3 format). No change of song will be allowed on the event day.","Round 2 – Prop Round: Props will be provided by the coordinator on the spot. The song will be played twice — first time for listening and choreography, second time for performance.","Round 3 – Mashup Round (Final):The mashup track will be played on the spot, and no prior listening or preparation will be permitted.","Time limits must be strictly followed. Exceeding the limit may lead to point deduction or disqualification.","Any form of misbehaviour or malpractice will result in disqualification.","Participants are responsible for their own safety during the performance.","Any damage to college property must be compensated by the participant.","Judging will be based on creativity, adaptability, expressions, energy, transitions, and stage presence.","Judges’ decisions are final and binding."], contact: [{name: "Vismaya", phone: "9539280934"}], regFee: "₹ 100" ,regLink:"https://docs.google.com/forms/d/e/1FAIpQLSexrs4qwNBeG2KJ5mYwqkdY0hcEcSU0REJ46i4E6ZdmYiHAbA/viewform?usp=dialog"},
    204: { id: 204, title: "5's Football", date: "Jan 16", time: "10:00 Am", location: "College Ground", image: "https://images.unsplash.com/photo-1434648957308-5e6a859697e8?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", icon: <Video />, desc: "Directing.", prize: "₹ 5,000", rules: ["Each team must consist of 5 players on the field.","Teams can have 3 substitute, making a total of 8 players.","Each match will last for 10 Minutes","Matches will begin promptly as per the schedule.","Teams arriving late by more than 5 minutes will forfeit the match.","Tied matches go to a penalty shootout (3 kicks per team, followed by sudden death if needed)","Limited to 16 teams","College ID Card is mandatory"], contact: [{name: "Aromal", phone: "7012629742"}], regFee: "₹ 350" ,regLink:"https://forms.gle/1e5ju3Wi6yrUwbio7"},
  };
